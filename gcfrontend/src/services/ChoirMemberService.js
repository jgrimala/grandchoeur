...
export const updateDisplayContact = async (id, displayContact) => {
    try {
        const response = await axios.put(`${API_BASE_URL}/choir-member/${id}/display-contact`, { display_contact: displayContact });
        return response.data;
    } catch (error) {
